...
const InventoryReportPage: React.FC = () => {
  ...
  const columns: DataTableColumn<InventoryItem>[] = [
    ...
    },
    {
      ...
      cell: (row) => (
        <span
          className={`inline-flex rounded-full px-3 py-1 text-xs font-medium ${(row.currentStock ?? 0) <= 0
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-1.5 text-sm rounded-md ${mode === "Daily"
          ...
          <button
            ...
            className={`px-4 py-1.5 text-sm rounded-md ${mode === "Monthly"
                ? "bg-[#2A9D8F] text-white"
                : "bg-[#E9E2C8] text-[#5E503F]"
              }`}
          >
