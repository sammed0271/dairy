      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={`rounded-md px-3 py-1.5 text-xs font-medium ${shiftFilter === "All"
          ...
          <button
            ...
            className={`rounded-md px-3 py-1.5 text-xs font-medium ${shiftFilter === "morning"
                ? "bg-[#2A9D8F] text-white"
                : "bg-[#E9E2C8] text-[#5E503F]"
              }`}
          >
          ...
          <button
            ...
            className={`rounded-md px-3 py-1.5 text-xs font-medium ${shiftFilter === "evening"
                ? "bg-[#2A9D8F] text-white"
                : "bg-[#E9E2C8] text-[#5E503F]"
              }`}
          >
