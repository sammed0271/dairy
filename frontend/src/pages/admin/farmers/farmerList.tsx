          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${milkFilter === "All"
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${milkFilter === "cow"
                    ? "bg-[#2A9D8F] text-white"
                    : "bg-[#E9E2C8] text-[#5E503F]"
                  }`}
              >
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${milkFilter === "buffalo"
                    ? "bg-[#2A9D8F] text-white"
                    : "bg-[#E9E2C8] text-[#5E503F]"
                  }`}
              >
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${milkFilter === "mix"
                    ? "bg-[#2A9D8F] text-white"
                    : "bg-[#E9E2C8] text-[#5E503F]"
                  }`}
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${statusFilter === "All"
                    ? "bg-[#2A9D8F] text-white"
                    : "bg-[#E9E2C8] text-[#5E503F]"
                  }`}
              >
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${statusFilter === "Active"
                    ? "bg-[#2A9D8F] text-white"
                    : "bg-[#E9E2C8] text-[#5E503F]"
                  }`}
              >
              ...
              <button
                ...
                className={`rounded-md px-3 py-1.5 text-xs font-medium ${statusFilter === "Inactive"
                    ? "bg-[#2A9D8F] text-white"
                    : "bg-[#E9E2C8] text-[#5E503F]"
                  }`}
              >
                    ...
                    >
                      ...
                      <td className="border-t border-[#E9E2C8] px-4 py-2">
                        <div className="flex flex-wrap gap-2">
                          {f.milkType.map((type) => (
                            <span
                              key={type}
                              className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium ${type === "cow"
                      ...
                      <td className="border-t border-[#E9E2C8] px-4 py-2">
                        <button
                          ...
                          className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium transition ${f.status === "Active"
          ...
          <div className="flex justify-center items-center gap-2 py-4">
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`px-3 py-1 text-sm border rounded ${currentPage === i + 1 ? "bg-[#2A9D8F] text-white" : "bg-white"
                  }`}
              >
                {i + 1}
              </button>
                    ...
                    (t) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 rounded-md border px-3 py-2 text-sm ${active
