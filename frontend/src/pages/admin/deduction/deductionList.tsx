...
const DeductionListPage: React.FC = () => {
  ...
  const columns: DataTableColumn<Deduction>[] = [
    ...
    },
    {
      ...
      cell: (row) => (
        <span
          className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium ${row.category === "Advance"
    ...
    },
    {
      ...
      cell: (row) => (
        <span
          className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium ${row.status === "Pending"
